...
const main = async () => {
  const onReveal = await new Ability({ name: 'On Reveal' })
  onReveal.save()
  const ongoing = await new Ability({ name: 'Ongoing' })
  ongoing.save()
  const noAbility = await new Ability({ name: 'No Ability' })
  noAbility.save()
  const discard = await new Ability({ name: 'Discard' })
  discard.save()
  const move = await new Ability({ name: 'Move' })
  move.save()
  const destroy = await new Ability({ name: 'Destroy' })
  destroy.save()
