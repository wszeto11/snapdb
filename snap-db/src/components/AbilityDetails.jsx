  ...
  return selectedAbility ? (
    <div className="detail">
      <div className="detail-header">
        ...
        <img className="front-face" src={selectedAbility.image} alt={selectedAbility.name} width="400" height="400" />
      </div>
        <div>
      ...
      <div className="info-wrapper">
        <div style={{ display: 'inline-block', justifyContent: 'space-between', textAlign: 'center'}}>
          ...
          <p style={{ marginLeft: '20%', marginRight: '20%' }}>{selectedAbility.description}</p>
          <Link to="/cards">
            <button>Cards</button>
          </Link>
        </div>
